...
describe("SingleTag", () => {
  ...
  test("single tag class instance img with attributes", () => {
    const tag = new SingleTag("img", {src: "path/to/image.jpg", class: "hero", alt: "hero image"})
    expect(tag.toString()).toBe('<img src="path/to/image.jpg" class="hero" alt="hero image">')
  })
})
