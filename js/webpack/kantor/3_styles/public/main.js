...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu_css__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_jade__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_jade___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__menu_jade__);
...
class Menu {
  constructor(options) {
    ...
    this.elem.innerHTML = __WEBPACK_IMPORTED_MODULE_1__menu_jade___default()(options);
...
// module
exports.push([module.i, ".menu .title {\n  padding: 0 6px 0 16px;\n  background: url(" + __webpack_require__(5) + ") left 1px no-repeat;\n  background-size: 14px;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n.menu .list {\n  display: none;\n  margin: 0;\n}\n\n.menu .list .a {\n  color: blue;\n}\n\n.menu.open .list {\n  display: block;\n}\n\n.menu.open .title {\n  background-image: url(" + __webpack_require__(4) + ");\n}\n", ""]);
...
buf.push("<span class=\"title\">" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</span><ui class=\"list\">");
// iterate items
;(function(){
  var $$obj = items;
...
buf.push("</ui>");}.call(this,"items" in locals_for_with?locals_for_with.items:typeof items!=="undefined"?items:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
}
...
let pandaMenu = new __WEBPACK_IMPORTED_MODULE_0__menu__["a" /* default */]({
  title: 'Menu панды',
  items: [{
    text: 'Яйца',
    href: '#eggs'
