import { format } from "../6-format-text"

describe("6-format_text", () => {
  test("with 32", () => {
    const text =
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec consectet" +
  ...
  test.skip("width 80", () => {
    const text =
      "Whmwpyeoa, fszpfaan aoaco. Aiye qi feiouo dfjv efa. Cn. Waa efoaascu ocpj ydvbgtiy " +
    ...
    const result60 =
      "Whmwpyeoa, fszpfaan aoaco. Aiye qi feiouo dfjv efa. Cn. Waa efoaascu ocpj" +
