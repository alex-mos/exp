...
describe("isBracketSequenceValid", () => {
  it("main", () => {
    ...
    expect(isBracketSequenceValid("function validation(string) { console.log(string) }")).toBe(true)
    expect(isBracketSequenceValid("function validation(string) { console.log(string)")).toBe(false)
  })
})
